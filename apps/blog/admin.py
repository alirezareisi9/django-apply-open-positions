...
class CategoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        (
            'Main',
            {
                'fields' : ['title', 'slug', 'image', 'description', 'parent_category', 'created_at', 'updated_at',]
            },
        ),
    ]

    list_display = ['title', 'is_sub_category', 'parent_category', 'created_at',]
...
class PostAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        (
            ...
            {
                'fields': ['title', 'slug', 'category', 'image', 'created_at', 'updated_at'],
            },
        ),
    ...
    list_display = ['title', 'created_at',]  # cannot set a value to manytomanyfield or reverse foreign key
    list_filter = ['created_at', 'updated_at', 'category',]
    list_display_links = ['title',]

    readonly_fields = ['created_at', 'updated_at',]

    search_fields = ['title', 'category', 'content', 'created_at',]
    ...
    raw_id_fields = ('category',)  # Makes a situation for us to search and check categories with details
